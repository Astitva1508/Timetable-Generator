...
<br />Teaching is done on faculty from 9AM until 5PM on each work day. 
...
3. If the subject has several forms of teaching, the preferred order for each group is the *lectures*, *tutorials*, and *laboratory exercises*.
...
Table is a matrix with dimensions 40 x number of classrooms, where 40 corresponds to total number of possible times during the week (5 workdays, 8 hours a day). 
